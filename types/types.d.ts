 ...
 */
export type DublinAwareAsset = FolderContainedAsset & DublinAwareAssetProperties;
/**
...
export type LinkRewriting = "inherit" | "absolute" | "relative" | "site-relative";
 ...
 */
export type SerializationType = "HTML" | "XML" | "PDF" | "RTF" | "JSON" | "JS" | "CSS";
...
export type ContentTypePageConfigurationPublishMode = "all-destinations" | "selected-destinations" | "do-not-publish";
/**
...
export type InlineEditableFieldType = "wired-metadata" | "dynamic-metadata" | "data-definition" | "xhtml";
 ...
 */
export type DynamicMetadataFieldType = "text" | "datetime" | "radio" | "dropdown" | "checkbox" | "multiselect";
/**
...
export type DynamicMetadataFieldDefinitionValues = DynamicMetadataFieldDefinitionValue;
 ...
 */
export type ScheduledDestinationMode = "all-destinations" | "selected-destinations";
 ...
 */
export type WorkflowNamingBehavior = "auto-name" | "name-of-definition" | "empty";
...
export type NamingRuleAsset = {
    namingRuleAsset?: "block" | "file" | "folder" | "page" | "symlink" | "template" | "reference" | "format";
};
...
export type IndexBlockProperties = {
     ...
     */
    renderingBehavior?: "render-normally" | "hierarchy" | "hierarchy-with-siblings" | "hierarchy-siblings-forward";
    /**
     ...
     */
    sortMethod?: "folder-order" | "alphabetical" | "last-modified-date" | "created-date";
    /**
 ...
 */
export type XhtmlDataDefinitionBlock = XhtmlDataDefinitionBlockProperties & ExpiringAsset;
...
export type AssetFactoryContainer = AssetFactoryContainerProperties & ContaineredAsset;
...
export type ContentTypeContainer = ContentTypeContainerProperties & ContaineredAsset;
...
export type ConnectorContainer = ConnectorContainerProperties & ContaineredAsset;
...
export type PageConfigurationSet = PageConfigurationSetProperties & ContaineredAsset;
...
export type PageConfigurationSetContainer = PageConfigurationSetContainerProperties & ContaineredAsset;
...
export type DataDefinitionContainer = DataDefinitionContainerProperties & ContaineredAsset;
...
export type SharedFieldContainer = SharedFieldContainerProperties & ContaineredAsset;
...
export type MetadataSetContainer = MetadataSetContainerProperties & ContaineredAsset;
...
export type SiteDestinationContainer = SiteDestinationContainerProperties & ContaineredAsset;
...
export type FileSystemTransport = FileSystemTransportProperties & ContaineredAsset;
...
export type TransportContainer = TransportContainerProperties & ContaineredAsset;
...
export type WorkflowDefinition = WorkflowDefinitionProperties & ContaineredAsset;
...
export type WorkflowDefinitionContainer = WorkflowDefinitionContainerProperties & ContaineredAsset;
...
export type WorkflowEmailContainer = WorkflowEmailContainerProperties & ContaineredAsset;
 ...
 */
export type SearchFieldString = "name" | "path" | "createdBy" | "modifiedBy" | "displayName" | "title" | "summary" | "teaser" | "keywords" | "description" | "author" | "blob" | "velocityFormatContent" | "xml" | "link";
...
export type ReadWorkflowSettingsResponse = OperationResult & ReadWorkflowSettingsResult;
 ...
 */
export type AuditTypes = "login" | "login_failed" | "logout" | "start_workflow" | "advance_workflow" | "edit" | "copy" | "create" | "reference" | "delete" | "delete_unpublish" | "check_in" | "check_out" | "activate_version" | "publish" | "unpublish" | "recycle" | "restore" | "move";
...
export type ReadWorkflowInformationResponse = OperationResult & ReadWorkflowInformationResult;
